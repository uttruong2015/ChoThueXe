(function (app) {
    app.controller('lapLichAddController', lapLichAddController);
    lapLichAddController.$inject = ['apiService', '$scope', 'notificationService','$state','commonService'];
    function lapLichAddController(apiService, $scope, notificationService, $state, commonService) {
