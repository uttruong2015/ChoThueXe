(function (app) {
    app.controller('phieuDangKyListController', phieuDangKyListController);

    phieuDangKyListController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter']
    function phieuDangKyListController($scope, apiService, notificationService, $ngBootbox, $filter) {
