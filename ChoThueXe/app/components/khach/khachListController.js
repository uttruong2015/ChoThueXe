(function (app) {
    app.controller('khachListController', khachListController);

    khachListController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter']
    function khachListController($scope, apiService, notificationService, $ngBootbox, $filter) {
        ...
        function deleteProductCategoryMulti() {
            $ngBootbox.confirm('Tất cả dữ liệu đã chọn sẽ bị xóa. Bạn muốn tiếp tục?').then(function () {
                ...
                apiService.del('/api/khach/deletemulti', config, function (result) {
        ...
        function deleteProductCategory(id) {
            $ngBootbox.confirm('Bạn chắc chắn muốn xóa bản ghi này?').then(function () {
                ...
                apiService.del('/api/khach/delete', config, function () {
        ...
        function getProductCategories(page) {
            ...
            apiService.get('/api/khach/getlistpaging', config, function (result) {
