(function (app) {
    ...
    revenueStatisticController.$inject = ['apiService', '$scope', 'notificationService', '$filter', 'commonService', '$state'];
    function revenueStatisticController(apiService, $scope, notificationService, $filter, commonService, $state) {
        if ($scope.kiemtrarole('PhoGiamDoc')=='PhoGiamDoc') {
            $scope.tableData = [];
